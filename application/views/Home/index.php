<main
	<div class="container pt-5">
		<div class="jumbotron rounded-lg shadow bg-dark text-white d-flex flex-column align-items-center justify-content-center">
			...
			<p class="lead">Halo namaku <?= /** @var string $nama */
				$nama ?>, biasa dipanggil <?= /** @var string $panggil */
				$panggil ?>!</p>
			<h4>
			...
			<a class="btn btn-light btn-lg font-weight-bold" href="About" role="button">About Me</a>
		</div>
	</div>
</main>
